...
@section('meta')
    ...
    <script type="text/javascript" src="{{ $search_type == $upper_case_environment  ? "https://js.squareup.com/v2/paymentform" : "https://js.squareupsandbox.com/v2/paymentform" }}"></script>
            ...
            <div class="offset-lg-2 offset-xl-2 col-sm-12 col-md-12 col-lg-10 col-xl-7">
                ...
                <div class="info-square-block sq-payment-form">
                    ...
                    <div id="sq-ccbox">
                        ...
                        <form id="nonce-form" novalidate action="{{ route('client.orders.request_square', $search_id) }}" method="post">
                            @csrf

...
<div class="section services-list">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="mb-3">JetOnset Services</h1>
    ...
    <div class="container services services-right">
        <div class="row">
            <div class="col-md-6 services-text">
                <h2 class="services-h2 color-white">Private Cargo Transportation | Luxury Car Relocation</h2>
                <p class="services-p color-white">Do you want to move a priceless or prized possession? From multi-million dollar luxury custom cars to archeological artifacts and relics of art from the past - there is no safer way to relocate them than with a private chartered jet. We have a fleet of jets varied enough to transport almost any object of any size.</p>
            </div>
    ...
    <div class="container services services-fullwidth">
        <div class="row">
            ...
            <div class="col-md-6 services-text">
                <h2 class="services-h2 color-white">Medical Tourism | Private Jet Ambulance</h2>
                <p class="services-p color-white">With the rise of medical tourism as a better alternative for certain individuals in certain situations, JetOnset can maximize your comfort and experience on the way to or from your treatment! We even have the capability in certain situations to effectively operate nearly as an ambulance with our fast service using our apps and technologies! Certain surgeries can be so expensive that you might end up saving money while you fly out to optimum luxury for the same procedure!</p>
            </div>
        </div>
    </div>
</div>

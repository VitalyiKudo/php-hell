...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.min.css.map"
        type="text/css">
    ...
    <link href="{{ strtoupper(getenv('APP_ENV')) === 'LOCAL' ? asset('css/app.css') : mix('css/app.min.css') }}"
        rel="stylesheet">
    <!--<link href="{{-- asset('css/custom.css') --}}" rel="stylesheet">-->

    <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
    <!-- <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBTI9h361xswcSvVdM2kDtpiwcslXmjUYU&callback=initMap&libraries=&v=weekly"
        defer></script>-->
...
<body>
    <div id="app">
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    @if (View::hasSection('book_page'))
                        <img src="{{ asset('images/svg/logo_white.svg') }}" loading="lazy" class="logo-img"
                            alt="JetOnset">
                    @else
                        ...
                        @guest()
                            <li class="nav-item item-position">
                                <a class="nav-link {{ Request::is('/') ? 'active' : '' }}"
                                    href="/">{{ __('Book a flight') }}</a>
                            </li>

                            <li class="nav-item item-position">
                                <a class="nav-link {{ Request::is('empty-leg') ? 'active' : '' }}"
                                    href="{{ url('empty-leg') }}">{{ __('Empty Legs') }}</a>
                            </li>

                            <li class="nav-item item-position">
                                <a class="nav-link {{ Request::is('services') ? 'active' : '' }}"
                                    href="{{ url('services') }}">{{ __('Services') }}</a>
                            </li>

                            <li class="nav-item item-position">
                                <a class="nav-link {{ Request::is('aircraft') ? 'active' : '' }}"
                                    href="{{ url('aircraft') }}">{{ __('Aircraft') }}</a>
                            </li>
                            <!--
                                <li class="nav-item">
                            ...
                            <li class="nav-item item-position">
                                <a class="nav-link {{ Request::is('blog') ? 'active' : '' }}"
                                    href="https://blog.jetonset.com/">{{ __('Blog') }}</a>
                            </li>
                        @else
                            ...
                            <li class="nav-item item-position auth-navbar">
                                <a class="nav-link {{ Request::is('profile*') ? 'active' : '' }}"
                                    href="{{ route('client.profile') }}">{{ __('Profile') }}</a>
                            </li>

                            <li class="nav-item item-position auth-navbar">
                                <a class="nav-link {{ Request::is('requests') ? 'active' : '' }}"
                                    href="{{ route('client.requests.index') }}">{{ __('Requests') }}</a>
                            </li>

                            <li class="nav-item item-position auth-navbar">
                                <a class="nav-link {{ Request::is('orders') ? 'active' : '' }}"
                                    href="{{ route('client.orders.index') }}">{{ __('Orders') }}</a>
                            </li>

                            <li class="nav-item item-position auth-navbar">
                                <a class="nav-link {{ Request::is('support') ? 'active' : '' }}"
                                    href="{{ url('support') }}">{{ __('Support') }}</a>
                            </li>
                        @endguest
                        ...
                        @guest()
                            ...
                            <li class="nav-item item-position border-lg-right margin-lg-left ">
                                <a class="nav-link nav-item-custom-color" href="{{ route('client.register') }}">
                                    ...
                                    <img src="/images/sg.svg" loading="lazy" class="icon-img mr-1 sg-icon"
                                        alt="..."></span>
                            ...
                            <li class="nav-item">
                                <svg width="2px" height="100%" preserveAspectRatio="none" viewBox="0 0 1 1"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <line opacity="0.1" x1="0.5" x2="0.5" y2="68"
                                        stroke="#2B4060" />
                                </svg>
                            </li>
                            <li class="nav-item item-position">
                                ...
                                <a class="nav-link" href="{{ route('client.login') }}">
                                    ...
                                    <img src="/images/key.svg" loading="lazy" class="icon-img mr-1 sg-icon"
                                        alt="...">
                                    {{ __('Log In') }}</a>
                            </li>
                        @else
        ...
        <main>
            @auth()
                {{-- Chat Button Icon. No need write now --}}
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-3 mb-lg-0 text-justify">
                        ...
                        <p class="mb-3">If you have any questions or concerns, don't hesitate to reach out to us
                            today! We'are happy to help!</p>
                        <a href="mailto:info@jetonset.com">
                            <p class="mb-3">
                                <i class="fas fa-envelope mr-3"><img loading="lazy"
                                        src="/images/jetonset-envelope.svg" alt="" width="12"
                                        height="12"></i>
                                info@jetonset.com
                            </p>
                        </a>
                        <p class="mb-3">JetOnset does not own or operate aircraft. All flights are operated by FAA
                            Certified Part 135 air carriers. Carriers providing service for JetOnset clients must meet
                            both FAA requirements and additional JetOnset standards.</p>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-4 order-1 mb-3">
                        <div class="row mb-0 justify-content-center">
                            <div class="col-auto">
                                <a href="https://www.facebook.com/JetOnset-107938548410959" target="_blank"><img
                                        src="/images/facebook-icon.webp" loading="lazy" class="social-ico"
                                        alt="..."></a>
                            </div>
                            <div class="col-auto">
                                <a href="https://www.instagram.com/jetonset/" target="_blank"><img
                                        src="/images/instagram-icon.webp" loading="lazy" class="social-ico"
                                        alt="..."></a>
                            </div>
                            <div class="col-auto">
                                <a href="https://twitter.com/jetonset1" target="_blank"><img
                                        src="/images/twitter-icon.webp" loading="lazy" class="social-ico"
                                        alt="..."></a>
                            </div>
                            <div class="col-auto">
                                <a href="https://www.pinterest.com/4jetonset/" target="_blank"><img
                                        src="/images/pinest-icon.webp" loading="lazy" class="social-ico"
                                        alt="..."></a>
                            </div>
                            <div class="col-auto">
                                <a href="https://jetonset.tumblr.com/" target="_blank"><img
                                        src="/images/tumblr-icon.webp" loading="lazy" class="social-ico"
                                        alt="..."></a>
                            </div>
                        </div>
                    </div>

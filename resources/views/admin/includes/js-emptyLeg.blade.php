...
/*
        $('#geoNameIdCityDeparture').on('change', '#icaoDeparture select', function () {
            alert(this.value);
            //this.value == '' ? $(this).addClass('color-placeholder') : $(this).removeClass('color-placeholder')
        });

        $( "#icaoDeparture" ).find(':selected').change(function() {
            //alert(this.value);
        });
        console.log($('#icaoDeparture').find(':selected').data('geoid'));
        */
    });

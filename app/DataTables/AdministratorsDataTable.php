...
class AdministratorsDataTable extends DataTable
{
    ...
    public function dataTable($query, DataTables $dataTables)
    {
        return $dataTables->collection($query)
            ...
            ->addColumn('action', function ($q) {
                return '<a href="'.route('admin.administrators.edit', $q['id']).'" class="edit btn btn-success btn-sm">Edit</a>';
            });
    }
     ...
     *
     * @param Administrator $collect
     *
     * @return mixed
     */
    public function query(Administrator $collect)
    {
        return $collect->getAdministrators();
    }
    ...
    {
        return 'Administrators_' . date('YmdHis');
    }
}
